...

        {
...

            {
...

                {
                    ...
                    response = await httpClient.PatchAsync(url, new StringContent(postPayload, Encoding.UTF8, "application/json")).ConfigureAwait(false);
...

                {
                    ...
                    response = await httpClient.PostAsync(url, new StringContent(postPayload, Encoding.UTF8, "application/json")).ConfigureAwait(false);
...

        {
...

            {
...

                {
                    ...
                    response = await client.PatchAsync(url, new StringContent(objectSerialized, Encoding.UTF8, "application/json")).ConfigureAwait(false);
...

                {
                    ...
                    response = await client.PostAsync(url, new StringContent(objectSerialized, Encoding.UTF8, "application/json")).ConfigureAwait(false);
